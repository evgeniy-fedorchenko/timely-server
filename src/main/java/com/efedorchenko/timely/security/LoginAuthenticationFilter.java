...
public class LoginAuthenticationFilter extends OncePerRequestFilter {
    ...
    @NotNull
    private RequestMatcher requiresAuthenticationMatcher = new AntPathRequestMatcher("/**");

    private final PasswordEncoder passwordEncoder;
    private final UserDetailsService userDetailsService;
    private final LoginAuthenticationConverter loginAuthenticationConverter;

    public void setRequiresAuthenticationMatcher(@NotNull RequestMatcher requiresAuthenticationMatcher) {
        Objects.requireNonNull(requiresAuthenticationMatcher, "requiresAuthenticationMatcher cannot be null");
